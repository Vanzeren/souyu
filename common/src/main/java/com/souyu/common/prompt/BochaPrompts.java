package com.souyu.common.prompt;

public final class BochaPrompts {

    private BochaPrompts() {
    }
    ...
    public static final String INPUT_SCHEMA_FIRST_SEARCH = """
            {
                "type": "object",
                "properties": {
                    "title": {"type": "string"},
    ...
    public static final String OUTPUT_SCHEMA_FIRST_SEARCH = """
            {
                "type": "object",
                "properties": {
    ...
    public static final String INPUT_SCHEMA_FIRST_SUMMARY = """
            {
                "type": "object",
                "properties": {
                    "title": {"type": "string"},
    ...
    public static final String OUTPUT_SCHEMA_FIRST_SUMMARY = """
            {
                "type": "object",
                "properties": {
    ...
    public static final String INPUT_SCHEMA_REFLECTION = """
            {
                "type": "object",
                "properties": {
                    "title": {"type": "string"},
    ...
    public static final String OUTPUT_SCHEMA_REFLECTION = """
            {
                "type": "object",
                "properties": {
                    "search_query": {"type": "string"},
    ...
    public static final String INPUT_SCHEMA_REFLECTION_SUMMARY = """
            {
                "type": "object",
                "properties": {
                    "title": {"type": "string"},
    ...
    public static final String OUTPUT_SCHEMA_REFLECTION_SUMMARY = """
            {
                "type": "object",
                "properties": {
    ...
    public static final String INPUT_SCHEMA_REPORT_FORMATTING = """
            {
                "type": "array",
                "items": {
                    "type": "object",
    ...
    public static final String SYSTEM_PROMPT_FIRST_SEARCH = String.format("""
            ...
            3. **search_last_24_hours** - 24小时内信息搜索工具
               - 适用于：需要了解最新动态、突发事件时
               - 特点：只搜索过去24小时内发布的内容

            4. **search_last_week** - 本周信息搜索工具
               - 适用于：需要了解近期发展趋势时
               - 特点：搜索过去一周内的主要报道
